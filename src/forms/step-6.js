  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">As a {this.props.values.gender} in your {this.props.values.age}'s, food activity should not be overlooked when it comes to your ability to burn fat. Which of the following best describes your <span className="text-demi">training experience</span>?</div>
            <Field
                    name="experience"
                    render={({ field }) => (
                        <>
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            ...
                            />
                            <span className="tutorial-quiz__text">I haven't tried exercises or just started</span>                     
                        </label>
                        ...
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            ...
                            />
                            <span className="tutorial-quiz__text">I have tried and practiced common exercises</span>                              
                        </label>
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            <input
                            {...field}
                            ...
                            onClick={this.handleClick}
                            />
                            <span className="tutorial-quiz__text">I have practiced exercising for years</span>                     
                        </label>
