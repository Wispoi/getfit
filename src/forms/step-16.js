...
import MemberSm12x from '../images/tmp/Avatar_2@2x.png';
import MemberSm1 from '../images/tmp/Avatar_2.png';
import MemberSm22x from '../images/tmp/Avatar_3@2x.png';
import MemberSm2 from '../images/tmp/Avatar_3.png';
import MemberSm32x from '../images/tmp/Avatar_4@2x.png';
import MemberSm3 from '../images/tmp/Avatar_4.png';
                            ...
                            <Slider {...settings} className="tutorial-members__slider js-slick-slider">
                                ...
                                <div className="tutorial-members__slide">
                                    <div className="tutorial-members__item">
                                        ...
                                        <img
                                            src={MemberSm1}
                                            srcSet={MemberSm12x + " 2x"}
                                            alt=""
                                        />
                                        </div>
                                        <div className="tutorial-members__text">
                                        <p>
                                            «The best! This app is so helpful it makes me sweat a lot! And I already see now my weight goes down»
                                        </p>
                                        </div>
                                        <div className="tutorial-members__note">
                                        David Smith
                                ...
                                <div className="tutorial-members__slide">
                                    <div className="tutorial-members__item">
                                        ...
                                        <img
                                            src={MemberSm2}
                                            srcSet={MemberSm22x + " 2x"}
                                            alt=""
                                        />
                                        </div>
                                        <div className="tutorial-members__text">
                                        <p>
                                            «Amazing  app! So happy I purchased it. I really like this app I see my progress really quick and it helps me stay on track and get the results  I want unlike the  other apps. This app is actually worth trying.»
                                        </p>
                                        </div>
                                        <div className="tutorial-members__note">
                                        Amanda Bright
                                ...
                                <div className="tutorial-members__slide">
                                    <div className="tutorial-members__item">
                                        ...
                                        <img
                                            src={MemberSm3}
                                            srcSet={MemberSm32x + " 2x"}
                                            alt=""
                                        />
                                        </div>
                                        <div className="tutorial-members__text">
                                        <p>
                                            «I started using this app recently and I can already say that this is awesome I've been working out a lot and been feeling more full!»
                                        </p>
                                        </div>
                                        <div className="tutorial-members__note">
                                        Anna Kette
