  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">Have you taken any <span className="text-demi">antibiotic medication</span> in the last 1,5 years?</div>
            <Field
                    name="antibiotic"
                    render={({ field }) => (
                        <>
