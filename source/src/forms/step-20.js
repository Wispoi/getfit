...
export class Step20 extends React.Component {
    handleClick = (e) => {
        setTimeout(() => {
  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">Do you have any <span className="text-demi">dietary restrictions </span> or <span className="text-demi">food allergies</span>?</div>
            <Field
                    name="restrictionsAllergies"
                    render={({ field }) => (
                        <>
