...
export class Step23 extends React.Component {
    handleClick = (e) => {
        setTimeout(() => {
  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">At what time of the day do you prefer to workout?</div>
            <Field
                    name="workoutTime"
                    render={({ field }) => (
                        <>
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            ...
                            />
                            <span className="tutorial-quiz__text">Morning</span>                     
                        </label>
                        ...
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            ...
                            />
                            <span className="tutorial-quiz__text">Afternoon</span>                              
                        </label>
                        <label className="tutorial-quiz__label tutorial-quiz__label--link">
                            <input
                            {...field}
                            ...
                            onClick={this.handleClick}
                            />
                            <span className="tutorial-quiz__text">Evening</span>                     
                        </label>
