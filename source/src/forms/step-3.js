  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-progressbar">
            ...
            <div className="tutorial-progressbar__line tutorial-progressbar__line--progress fifteen-percent"></div>
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">What is your gender?</div>
            <Field
                    name="gender"
                    render={({ field }) => (
                        <>
