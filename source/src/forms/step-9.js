  ...
  return (
    <div className="tutorial-quiz__container tutorial-quiz__container--visible">
        ...
        <div className="tutorial-progressbar">
            ...
            <div className="tutorial-progressbar__line tutorial-progressbar__line--progress thirty-five-percent"></div>
        ...
        <div className="tutorial-quiz__item tutorial-quiz__item--current">
            ...
            <div className="tutorial-quiz__title tutorial-quiz__title--left">Do you have any significant <span className="text-demi">back issues</span>?</div>
            <Field
                    name="backIssues"
                    render={({ field }) => (
                        <>
